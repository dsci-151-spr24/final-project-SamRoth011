...
To support the hypothesis, the results would need to show clear correlation between energy and popularity, as well as danceability and popularity, and not show much or any correlation between the other musical varibles and popularity.
